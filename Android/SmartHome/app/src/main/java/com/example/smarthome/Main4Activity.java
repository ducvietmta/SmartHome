...
public class Main4Activity extends AppCompatActivity {
    Button mBtnLight, mBtnFan, mBtnWindow, mBtnDoor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnFan = findViewById(R.id.btnFanLR);
        mBtnWindow = findViewById(R.id.btnDoorLR);
        mBtnDoor = findViewById(R.id.btnWindowLR);
